...
import static co.com.screenplay.project.ui.HomeLocatorsUI.BTN_ELEMENTS;
import static co.com.screenplay.project.ui.HomeLocatorsUI.BTN_LIST_ELEMENTS;
...
public class ChooseSubElementsRandomTask implements Task {
    ...
    @Override
    @Step("{0} selecciona aleatoriamente la posición #numberRamdonBtn de la sub función de elementos")
